...
let visitou = prompt("Ele já visitou alguma cidade? sim/não")
let cidade = prompt("Qual o nome da cidade?")

while (visitou == "sim") {
    visitou = prompt("Ele visitou mais alguma? sim/não")
    cidade = prompt("Me informe o nome da cidade:")
    if( visitou == "não"){
        break
    }
